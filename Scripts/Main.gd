...
@onready var close_button = $menu/QuitButton
@onready var game_ui = $GameUI
@onready var money_display = $GameUI/Status/VBoxContainer/HBoxContainer/MoneyLabel
@onready var caught_count_display = $GameUI/Status/VBoxContainer/HBoxContainer/CaughtCountLabel
@onready var max_caught_display = $GameUI/Status/VBoxContainer/HBoxContainer/MaxCaughtLabel
@onready var game_message_label = $GameUI/GameMessage
@onready var room_title_label = $GameUI/CurrentRoom/VBoxContainer/RoomTitle
@onready var family_alert_label = $GameUI/CurrentRoom/VBoxContainer/FamilyAlert
@onready var item_actions_container = $GameUI/CurrentRoom/VBoxContainer/ItemActions
@onready var next_navigation_buttons_container = $GameUI/NavigationP/VBoxContainer/NavigationButtons
@onready var previews_navigation_buttons_container = $GameUI/NavigationP/VBoxContainer/NavigationButtons
...
@onready var main_menu_button_game_over = $GameOverScreen/MainMenuBtn
@onready var family_move_timer = $GameUI/FamilyMoveTimer
...
func _ready():
	...
	if qte_overlay.has_signal("qte_result"):
...
func update_ui():
	...
	for child in next_navigation_buttons_container.get_children():
		child.queue_free() # Remove botões antigos
	...
	for exit_key in GameManager.rooms[current_room_key].exits:
		...
		next_navigation_buttons_container.add_child(button)
...
func _on_game_over_status_changed(is_over: bool):
	...
	game_ui.visible = not is_over # Esconde a interface do jogo quando Game Over
...
func _on_family_move_timer_timeout():
	...
	while true:
		...
		if new_family_location_key != current_room_key:
			break
